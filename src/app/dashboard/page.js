        ...
        <>
          ...
          {videoError && (
            <div className="border-t border-amber-400/20 bg-amber-400/10 px-4 py-3 text-xs leading-5 text-amber-100">
              The video file was found, but the browser cannot play its codec. OpenCV often exports MP4V; convert it to H.264 and save it in the same videos folder with a name like <span className="font-semibold">*_browser.mp4</span>.
            </div>
          )}
        </>
      ) : (
