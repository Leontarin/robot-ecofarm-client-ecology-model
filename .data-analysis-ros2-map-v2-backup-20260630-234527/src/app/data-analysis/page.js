    ...
    <main className="min-h-screen bg-slate-950 px-4 py-6 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-[1600px] space-y-6">
        ...
        {payload && activeTab === "map" ? (
          <section className="space-y-6">
            <TimelineControls buckets={timelineBuckets} bucketPosition={safeBucketPosition} setBucketPosition={setBucketPosition} layer={layer} setLayer={setLayer} timeScale={timeScale} setTimeScale={setTimeScale} />
            <GreenhouseMap
